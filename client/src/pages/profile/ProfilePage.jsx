    ...
    const handleImgChange = (e, state) => {
        ...
        if (file) {
            ...
            reader.onload = () => {
                ...
                console.log(state === "coverImg" ? "Cover Image updated" : "Profile Image updated");
            };
    ...
    return (
        <div className="flex-[4_4_0] border-r border-gray-700 min-h-screen">
            <div className="flex flex-col">
                ...
                {isMyProfile && <div className="flex justify-end px-4 mt-5"><EditProfileModal authUser={authUser} /></div>}
                <div className="flex flex-col gap-5 mt-14 px-4">
                    <div className="flex flex-col fgap-2 ">
                ...
                <div className="flex w-full border-b border-gray-700 mt-4">
                    <div className="flex justify-center flex-1 p-3 hover:bg-secondary transition duration-300 relative cursor-pointer" onClick={() => setFeedType("posts")}>Posts{feedType === "posts" && <div className="absolute bottom-0 w-10 h-1 rounded-full bg-primary" />}</div>
                    <div className="flex justify-center flex-1 p-3 text-slate-500 hover:bg-secondary transition duration-300 relative cursor-pointer" onClick={() => setFeedType("likes")}>Likes{feedType === "likes" && <div className="absolute bottom-0 w-10 h-1 rounded-full bg-primary" />}</div>
                </div>
